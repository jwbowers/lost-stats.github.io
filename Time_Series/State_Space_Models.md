...
For additional information about the state-space representation, refer to [Wikipedia: State-Space Representation](https://en.wikipedia.org/wiki/State-space_representation).
